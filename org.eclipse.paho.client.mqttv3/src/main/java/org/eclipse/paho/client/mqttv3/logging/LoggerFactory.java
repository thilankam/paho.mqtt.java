...
public class LoggerFactory {
   ...
   */
  public final static String MQTT_CLIENT_MSG_CAT =
  ...
  public static Logger getLogger(String messageCatalogName, String loggerID) {
    ...
    if (null == logger) {
      throw new MissingResourceException("Error locating the logging class",
          CLASS_NAME, loggerID);
    }
   ...
   */
  private static Logger getLogger(String loggerClassName,
      ResourceBundle messageCatalog, String loggerID, String resourceName) { // ,
                                                                             // FFDC
                                                                             // ffdc)
                                                                             // {
    Logger logger = null;
  ...
  public static String getLoggingProperty(String name) {
    ...
    try {
      ...
      Method m2 = logManagerClass.getMethod("getProperty",
   ...
   * set getLogger will attempt to create a logger appropriate for the platform.
   * 
