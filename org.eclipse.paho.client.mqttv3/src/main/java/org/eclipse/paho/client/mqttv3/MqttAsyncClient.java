...
public class MqttAsyncClient implements IMqttAsyncClient { 
  ...
  // LoggerFactory.getLogger(LoggerFactory.MQTT_CLIENT_MSG_CAT,CLASS_NAME);
    ...
    // log.fine(CLASS_NAME,methodName,"101",new
    // Object[]{clientId,serverURI,persistence});
...
//		log.fine(CLASS_NAME,methodName, "103",
    ...
    // log.fine(CLASS_NAME,methodName, "104",new Object[]{ new
    // Long(quiesceTimeout), userContext, callback});
    ...
    // subs.append(", ");
    // }
    // subs.append("topic=").append(topicFilters[i]).append("
    // qos=").append(qos[i]);
    //
    ...
    // log.fine(CLASS_NAME,methodName,"106",new Object[]{subs.toString(),
    ...
    // log.fine(CLASS_NAME, methodName,"107",new Object[]{subs, userContext,
    // callback});
    // }
    ...
    // log.fine(CLASS_NAME,methodName,"111", new Object[] {topic, userContext,
    // callback});
    ...
    // log.fine(CLASS_NAME, methodName, "500", new Object[]{this.clientId});
		try {
          ...
          // log.fine(CLASS_NAME, methodName, "501", new
          // Object[]{asyncActionToken.getClient().getClientId()});
          ...
          // log.fine(CLASS_NAME, methodName, "502", new
          // Object[]{asyncActionToken.getClient().getClientId()});
    ...
    // log.fine(CLASS_NAME, methodName, "503", new Object[]{this.clientId, new
    // Long(reconnectDelay)});
    ...
    // log.fine(CLASS_NAME, methodName, "505", new Object[]{this.clientId, new
    // Long(reconnectDelay)});
		synchronized(clientLock) {
			if(this.connOpts.isAutomaticReconnect()) {
				if (reconnectTimer != null) {
