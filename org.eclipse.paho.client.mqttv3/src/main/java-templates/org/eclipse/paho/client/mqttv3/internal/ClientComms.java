...
public class ClientComms {
  ...
  // LoggerFactory.getLogger(LoggerFactory.MQTT_CLIENT_MSG_CAT,CLASS_NAME);
    ...
    // log.fine(CLASS_NAME, methodName, "200", new Object[]{message.getKey(),
    // message, token});
      ...
      // log.fine(CLASS_NAME, methodName, "213", new Object[]{message.getKey(),
      // message, token});
	...
	public void sendNoWait(MqttWireMessage message, MqttToken token) throws MqttException {
        ...
        // log.fine(CLASS_NAME, methodName, "507", new Object[]
        // {message.getKey()});
      ...
      // log.fine(CLASS_NAME, methodName, "508", new Object[]
      // {message.getKey()});
			if(disconnectedMessageBuffer.isPersistBuffer()){
				this.clientState.persistBufferedMessage(message);
			}
	...
	public void connect(MqttConnectOptions options, MqttToken token) throws MqttException {
        ...
        // log.fine(CLASS_NAME,methodName,"207", new Object[] {new
        // Byte(conState)});
	...
	public void notifyReconnect() {
      ...
      // log.fine(CLASS_NAME, methodName, "509");
			disconnectedMessageBuffer.setPublishCallback(new IDisconnectedBufferCallback() {
                ...
                // log.fine(CLASS_NAME, methodName, "510", new Object[]
                // {bufferedMessage.getMessage().getKey()});
